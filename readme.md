# VB Decompiler Plugin SDK for Delphi

This repository contains the official Plugin Development Kit (SDK) for [**VB Decompiler**](https://www.vb-decompiler.org), written in **Delphi**.
...
*   **Compiler/IDE:**
    *   Delphi 7 or newer (Successfully tested on latest Delphi 13).

## 🛠️ How to Build

1.  Clone this repository:
    ```bash
    git clone https://github.com/DotFixSoft/VBDecompilerPluginSDK_Delphi.git
    ```

2.  Open the project in your IDE:
   Open `DelphiPlugin.dpr`.
...
For a full list of commands and constants, please refer to the `DelphiPlugin.dpr` file in this repository or the [Official Documentation](https://www.vb-decompiler.org/plugins_sdk.htm).
